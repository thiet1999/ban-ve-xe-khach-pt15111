            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <table class="table table-stripped">
                        ...
                        <th>
                            <a href="<?php echo ADMIN_URL . 'vehicle_types/add-form.php' ?>" class="btn btn-primary btn-sm"><i
                        ...
                        <?php foreach ($vehicleTypes as $type): ?>
                            <tr>
                                ...
                                <td><?php
                                    ...
                                    ?></td>
                                <td>
                                    <a href="<?php echo ADMIN_URL . 'vehicle_types/edit-form.php?id=' . $type['id'] ?>"
                                       class="btn btn-sm btn-info">
                                        <i class="fa fa-pencil-alt"></i>
                                    </a>
                                    <a href="<?php echo ADMIN_URL . 'vehicle_types/remove.php?id=' . $type['id'] ?>"
